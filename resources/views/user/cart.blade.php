              ...
              <div class="p-6 bg-white border-b border-gray-200">
                  @if(count($products)>0)
                    ...
                    <div class="md:flex md:items-center mb-2">
                      ...
                      <div class="md:w-3/12 flex md:justify-around">
                        <div>{{$product->pivot->quantity}}個</div>
                        <div>{{number_format($product->pivot->quantity*$product->price)}}<span class="text-sm text-gray-400">円(税込)</span></div>
                      </div>
                      <div class="md:w-2/12">
                    ...
                    @endforeach
                    <div class="my-2">
                    小計:{{number_format($totalPrice)}}<span class= "text-sm text-gray-400">円<span>
                    </div>
                    <div>
